...
public:
  ...
  Adafruit_SSD1306(uint8_t w, uint8_t h, i2c_inst_t *wire = i2c_default, int8_t rst_pin = -1, uint clkDuring = 800*1000, uint clkAfter = 100000);
...
protected:
  ...
  spi_inst_t *spi;
  i2c_inst_t *wire = i2c0; ///< Initialized during construction when using I2C.
  ...
  uint32_t clkDuring; ///< Clock frequency intended for the SSD3306
  uint32_t clkAfter; ///< Clock frequency to restore following transactions
};
